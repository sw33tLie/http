...
func TestCmdGoNoHTTPServer(t *testing.T) {
	...
	wantSym := map[string]bool{
		...
		"github.com/sw33tLie/http.(*Client).do":           true,
		"github.com/sw33tLie/http.(*Transport).RoundTrip": true,

		// Verify these don't exist:
		"github.com/sw33tLie/http.http2Server":           false,
		"github.com/sw33tLie/http.(*Server).Serve":       false,
		"github.com/sw33tLie/http.(*ServeMux).ServeHTTP": false,
		"github.com/sw33tLie/http.DefaultServeMux":       false,
	}
...
func TestOmitHTTP2(t *testing.T) {
	...
	out, err := testenv.Command(t, goTool, "test", "-short", "-tags=nethttpomithttp2", "github.com/sw33tLie/http").CombinedOutput()
	if err != nil {
...
func TestOmitHTTP2Vet(t *testing.T) {
	t.Parallel()
	goTool := testenv.GoToolPath(t)
	out, err := testenv.Command(t, goTool, "vet", "-tags=nethttpomithttp2", "github.com/sw33tLie/http").CombinedOutput()
	if err != nil {
